...
if __name__ == "__main__":
    ...
    with open('/home/angeles/Escritorio/Lab3/rockyou_mod.dic', encoding='ISO-8859-1') as f:
        S = []
        for l in f:
            S.append(l.strip())
    #ssid name
